...
"""
"""
代码功能：采用在ImageNet上预训练的VGG16模型进行分类测试
"""
...
def process_img(path_img):
    ...
    norm_std = [0.229, 0.224, 0.225]    ## 这是根据ImageNet上统计得到的mean和std
...
if __name__ == "__main__":
    ...
    # path_img = os.path.join(BASE_DIR, "..", "data", "Golden Retriever from baidu.jpg")  ## dog
    path_img = os.path.join(BASE_DIR, "..", "data", "tiger cat.jpg")                           ## cat
    ...
    ## --- test ---
    # print(f"cls_n.size = {len(cls_n)}")
    # print(f"cls_n_cn.size = {len(cls_n_cn)}")
    # print(f"cls_n[0] = {cls_n[0]}")
    # print(f"cls_n_cn[0] = {cls_n_cn[0]}")
    ## --- test ---
